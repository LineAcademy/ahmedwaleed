...
<script setup>
  ...
  definePerson({
    ...
    useHead({
        title: 'مقالات عن البرمجة',
        meta: [
            { name: 'description', content: 'مقالات احمد وليد برمجة , مقالات برمجة في مصر , احمد يحب مساعدة الوافدين الجدد في مجال صناعة البرمجيات علي تعلم جافاسكريبت , رياكت , فيو , نيكست , اختبار الويب , جو , بي اتش بي' },
            { name: 'keywords', content: ' مقالات احمد وليد برمجة, مقالات احمد برمجة مواقع, مقالات برمجة الويب, مقالات فرونت اند, مقالات باك اند, مقالات جافاسكريبت, مقالات رياكت, فيو, نيكست, تايبسكريبت, معلم برمجة مواقع, افضل مبرمج مواقع في مصر' },
            { name: 'apple-mobile-web-app-title', content:'احمد وليد مدرب برمجة المواقع | مقالات البرمجة' },
            { name: 'application-name', content:'احمد وليد مدرب برمجة المواقع | مقالات البرمجة' },
            { name: 'og:url', content: 'https://ahmed.lineitsolutions.com' },
            { name: 'og:site_name', content:'احمد وليد مدرب برمجة المواقع | مقالات البرمجة' },
            { name: 'og:title', content:'احمد وليد مدرب برمجة المواقع | مقالات البرمجة' },
            { name: 'og:description', content:'احمد وليد مدرب برمجة المواقع | مقالات البرمجة' },
            ...
            { name: 'subject', content: 'مقالات البرمجة - أحمد وليد مدرب برمجة مواقع في مصر' },
            { name: 'note', content: 'مقالات البرمجة - أحمد وليد مدرب برمجة مواقع في مصر' },
            { name: 'msapplication-tooltip', content: 'مقالات البرمجة - أحمد وليد مدرب برمجة مواقع في مصر' },
        ],
