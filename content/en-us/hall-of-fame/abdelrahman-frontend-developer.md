...
description: everyone with us in the group walked with us and we all learned
  together and worked in companies including in Egypt and remotly from abroad.
  Thanks to Ahmed Ali...
image: abdrahman
subImage: sub_page_14_sootul
---
<p style="
    margin: 0;
">Follow Abdelrahman :</p>
...
**Abdel-Rahman was helping with all the programming groups, and all the groups are thankful for his treatment. He is a very smart and hardworking person.**

God willing, someone with us in the group walked with us and we all learned together and worked in companies including in Egypt and remotly from abroad. Thanks to Ahmed Ali...

> Task from Abdul Rahman Programming Groups ***:***

![Task from Abdul Rahman for programming groups](https://res.cloudinary.com/drcfigqqr/image/upload/v1689014146/Screenshot_66_x4kztv.webp "Task from Abdul Rahman for programming groups")